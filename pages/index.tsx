  ...
  return (
    <div className='min-h-screen pb-16 w-10/12 max-w-xl mx-auto'>
      <section className='text-center flex flex-col items-center'>
        ...
        <H3 className='mt-8'>Jembatan interaksi dengan penontonmu!</H3>
      ...
      <section className='mt-10 flex flex-col gap-y-12'>
        ...
        >
          <div className='space-y-5 w-[26ch]'>
            <Mono>
              Setiap transaksi masuk akan terkena biaya sebesar 5% (6% untuk
              OVO) dengan batas minimum 150 rupiah
            </Mono>
        ...
        <footer className='flex justify-between text-lg font-mono'>
